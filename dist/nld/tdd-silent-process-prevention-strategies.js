...
exports.tddSilentProcessPrevention = exports.TDDSilentProcessPreventionStrategies = void 0;
...
describe('Process Health Monitoring', () => {
  ...
  test('should provide diagnostic information for silent processes', async () => {
     ...
     */
    generateTestImplementation(patternId) {
    ...
    getSetupRequirementsForTests(tests) {
     ...
     */
    recordTestResult(testId, passed, preventedPatterns) {
        if (passed) {
...
exports.TDDSilentProcessPreventionStrategies = TDDSilentProcessPreventionStrategies;
// Export singleton instance
exports.tddSilentProcessPrevention = new TDDSilentProcessPreventionStrategies();
//# sourceMappingURL=tdd-silent-process-prevention-strategies.js.map