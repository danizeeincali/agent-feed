...
exports.MixedVersioningTDDTestCases = void 0;
const fs_1 = require("fs");
const path = __importStar(require("path"));
class MixedVersioningTDDTestCases {
    testCasesPath;
    constructor() {
  ...
  test('should create EventSource with unified endpoints', () => {
    ...
    expect(global.EventSource).toHaveBeenCalledWith(
      expect.stringContaining('/api/claude/instances/')
        ...
        await fs_1.promises.mkdir(this.testCasesPath, { recursive: true });
        ...
        for (const testCase of testCases) {
            ...
            await fs_1.promises.writeFile(filePath, testCase.testCode, 'utf-8');
        }
     ...
     */
    async generateTestSuiteSummary(testCases) {
        const summary = {
        ...
        await fs_1.promises.writeFile(summaryPath, JSON.stringify(summary, null, 2), 'utf-8');
        console.log(`📋 Test suite summary generated: ${summaryPath}`);
    }
}
exports.MixedVersioningTDDTestCases = MixedVersioningTDDTestCases;
exports.default = MixedVersioningTDDTestCases;
//# sourceMappingURL=tdd-mixed-versioning-test-cases.js.map