...
exports.MixedAPIVersioningDetector = void 0;
const crypto_1 = require("crypto");
const fs_1 = require("fs");
const path = __importStar(require("path"));
class MixedAPIVersioningDetector {
    patterns = [];
    patternStorePath;
    neuralTrainingPath;
    constructor() {
     ...
     */
    async detectMixedVersioningPatterns(codebaseFiles) {
     ...
     */
    async createMixedVersioningPattern(basePath, usage) {
        ...
        for (const versioned of usage.versioned) {
            for (const unversioned of usage.unversioned) {
                endpointPairs.push({
                    ...
                    failureMode: this.determineFailureMode(versioned, unversioned)
                });
            }
        }
        return {
     ...
     */
    determineFailureMode(versioned, unversioned) {
     ...
     */
    generateRedirectRules(basePath) {
        return [
     ...
     */
    generateEndpointConfig(basePath) {
     ...
     */
    generateIntegrationTests(basePath, endpointPairs) {
        return [
     ...
     */
    async exportNeuralTrainingDataset() {
        const trainingData = {
            version: '1.0.0',
        ...
        await fs_1.promises.writeFile(this.neuralTrainingPath, JSON.stringify(trainingData, null, 2), 'utf-8');
    ...
    async persistPatterns() {
        ...
        await fs_1.promises.writeFile(this.patternStorePath, JSON.stringify(data, null, 2), 'utf-8');
    }
    /**
    ...
    async loadPatterns() {
        try {
            const data = await fs_1.promises.readFile(this.patternStorePath, 'utf-8');
...
exports.MixedAPIVersioningDetector = MixedAPIVersioningDetector;
exports.default = MixedAPIVersioningDetector;
//# sourceMappingURL=mixed-api-versioning-anti-pattern-detector.js.map