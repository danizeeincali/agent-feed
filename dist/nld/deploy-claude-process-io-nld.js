...
exports.claudeProcessIODeployment = exports.claudeProcessIOIntegration = void 0;
exports.deployClaudeProcessIONLD = deployClaudeProcessIONLD;
exports.validateClaudeProcessIODeployment = validateClaudeProcessIODeployment;
exports.demonstrateClaudeProcessIONLD = demonstrateClaudeProcessIONLD;
const claude_process_io_deployment_demo_1 = require("./claude-process-io-deployment-demo");
 ...
 */
async function deployClaudeProcessIONLD() {
    ...
    try {
        ...
        deploymentResult = await claude_process_io_deployment_demo_1.claudeProcessIODeployment.deployAndDemonstrate();
        // Generate system report
        const systemReport = await claude_process_io_deployment_demo_1.claudeProcessIODeployment.generateDeploymentReport(deploymentResult);
...
function generateNextSteps(deploymentResult) {
    const steps = [];
 ...
 */
async function validateClaudeProcessIODeployment() {
    try {
 ...
 */
async function demonstrateClaudeProcessIONLD() {
    ...
    try {
        ...
        claude_process_io_integration_system_1.claudeProcessIOIntegration.registerClaudeProcess('demo-print-error', 'claude', ['--print'], // Missing input
        '/workspaces/agent-feed');
        await new Promise(resolve => setTimeout(resolve, 1000));
        const alerts = claude_process_io_integration_system_1.claudeProcessIOIntegration.getActiveAlerts('demo-print-error');
        ...
        const testSuite = claude_process_io_integration_system_1.claudeProcessIOIntegration.generateTestSuite('PRINT_FLAG_INPUT_REQUIRED');
...
//# sourceMappingURL=deploy-claude-process-io-nld.js.map