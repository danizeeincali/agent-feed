...
exports.NeuralTrainingExportSystem = void 0;
...
class NeuralTrainingExportSystem {
    patternDetector;
    antiPatternsDB;
    tddStrategies;
    exportDir;
    ...
    constructor(exportDir) {
        ...
        this.exportDir = exportDir || path_1.default.join(__dirname, '..', '..', 'neural-exports');
        this.ensureExportDirectory();
    }
    ensureExportDirectory() {
        if (!fs_1.default.existsSync(this.exportDir)) {
            fs_1.default.mkdirSync(this.exportDir, { recursive: true });
        }
    }
    /**
     ...
     */
    convertPatternToTrainingRecord(pattern) {
        return {
            id: pattern.id,
            input: {
                connectionState: {
    ...
    async saveDataset(dataset) {
        ...
        const filepath = path_1.default.join(this.exportDir, filename);
        fs_1.default.writeFileSync(filepath, JSON.stringify(dataset, null, 2));
        // Also save a claude-flow compatible format
        const claudeFlowFormat = this.convertToClaudeFlowFormat(dataset);
        const claudeFlowPath = path_1.default.join(this.exportDir, `claude-flow-${filename}`);
        fs_1.default.writeFileSync(claudeFlowPath, JSON.stringify(claudeFlowFormat, null, 2));
        return filepath;
    }
    /**
    ...
    generateSyntheticOutput(failureMode) {
        return {
            failurePrediction: {
                willFail: true,
...
exports.NeuralTrainingExportSystem = NeuralTrainingExportSystem;
//# sourceMappingURL=neural-training-export-system.js.map