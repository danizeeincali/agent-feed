...
const nld_rate_limiting_validation_orchestrator_1 = require("./nld-rate-limiting-validation-orchestrator");
const nld_logger_1 = require("./utils/nld-logger");
async function main() {
    try {
        console.log('🚀 Starting NLD Rate Limiting Validation Pipeline...\n');
        // Execute the complete validation pipeline
        const result = await nld_rate_limiting_validation_orchestrator_1.nldRateLimitingValidationOrchestrator.executeValidationPipeline();
        // Generate and display the pattern detection summary
        const summary = nld_rate_limiting_validation_orchestrator_1.nldRateLimitingValidationOrchestrator.generatePatternDetectionSummary(result);
        ...
        nld_logger_1.nldLogger.renderFailure('execute-rate-limiting-validation', error);
        process.exit(1);
    }
}
...
//# sourceMappingURL=execute-rate-limiting-validation.js.map