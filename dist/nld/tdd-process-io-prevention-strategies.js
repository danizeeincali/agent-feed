...
exports.TDDProcessIOPreventionStrategies = void 0;
class TDDProcessIOPreventionStrategies {
...
describe('SSE Connection Failure Recovery', () => {
  test('should handle dead connections and cleanup properly', async () => {
    ...
    getTestPatternById(testId) {
        return this.testPatterns.get(testId);
    }
    getTestPatternsByCategory(category) {
        return Array.from(this.testPatterns.values())
            .filter(pattern => pattern.testCategory === category);
    }
    getTestPatternsForFailure(failurePatternId) {
        return Array.from(this.testPatterns.values())
...
exports.TDDProcessIOPreventionStrategies = TDDProcessIOPreventionStrategies;
//# sourceMappingURL=tdd-process-io-prevention-strategies.js.map