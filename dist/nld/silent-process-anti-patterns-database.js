...
exports.silentProcessAntiPatternsDB = exports.SilentProcessAntiPatternsDatabase = void 0;
class SilentProcessAntiPatternsDatabase {
     ...
     */
    detectAntiPatterns(processInfo, context) {
    ...
    evaluatePattern(pattern, processInfo, context) {
        let confidence = 0;
    ...
    calculatePatternSpecificConfidence(pattern, processInfo, context) {
        let boost = 0;
    ...
    recordPatternDetection(patternId, instanceId, confidence) {
...
exports.SilentProcessAntiPatternsDatabase = SilentProcessAntiPatternsDatabase;
// Export singleton instance
exports.silentProcessAntiPatternsDB = new SilentProcessAntiPatternsDatabase();
//# sourceMappingURL=silent-process-anti-patterns-database.js.map