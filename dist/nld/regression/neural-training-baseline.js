...
exports.neuralTrainingBaseline = exports.NeuralTrainingBaseline = void 0;
class NeuralTrainingBaseline {
    baseline = null;
    captureStartTime = new Date();
    observationPeriod = 30000; // 30 seconds
    observedEvents = [];
    /**
     ...
     */
    async captureClaudeProcessBaseline() {
        return {
     ...
     */
    async captureAuthenticationBaseline() {
        return {
     ...
     */
    async captureDirectoryBaseline() {
        return {
     ...
     */
    async captureSSEConnectionBaseline() {
        return {
     ...
     */
    async captureProcessSpawningBaseline() {
        return {
            spawnCommands: {
                prod: ['claude'],
     ...
     */
    async generateNeuralSignatures() {
        const signatures = [];
     ...
     */
    validateAgainstBaseline(currentConfig) {
        if (!this.baseline) {
...
exports.NeuralTrainingBaseline = NeuralTrainingBaseline;
// Export singleton instance
exports.neuralTrainingBaseline = new NeuralTrainingBaseline();
// Auto-capture baseline
exports.neuralTrainingBaseline.captureBaseline().then(() => {
    console.log('✅ Neural training baseline captured from working system');
});
console.log('📊 Neural Training Baseline system initialized');
//# sourceMappingURL=neural-training-baseline.js.map