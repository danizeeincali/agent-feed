...
class PerformanceAnalyzer extends events_1.EventEmitter {
    ...
    trendWindow = 300; // 5 minutes for trend analysis
    constructor() {
        super();
    }
    startAnalysis(intervalMs = 30000) {
        if (this.isAnalyzing) {
    ...
    detectCPUBottleneck(latest, recent) {
    ...
    detectMemoryBottleneck(latest, recent) {
    ...
    detectNetworkBottleneck(latest, recent) {
    ...
    detectDiskBottleneck(latest, recent) {
    ...
    detectApplicationBottleneck(latest, recent) {
    ...
    analyzeApplicationTrend(metrics) {
    ...
    createOptimizationForBottleneck(bottleneck) {
    ...
    createProactiveOptimization(trend) {
    ...
    calculatePersistence(bottleneckId, currentTime) {
