...
export class ClaudeProcessIOTDDPreventionStrategies {
  private testSuites: Map<string, ClaudeProcessIOTDDSuite> = new Map();
  ...
  private createPrintFlagInputRequiredSuite(): void {
    const suite: ClaudeProcessIOTDDSuite = {
  ...
  private createInteractiveModeBlockedSuite(): void {
    const suite: ClaudeProcessIOTDDSuite = {
  ...
  private createPTYStdinDisconnectSuite(): void {
    const suite: ClaudeProcessIOTDDSuite = {
  ...
  private createAuthSuccessNoOutputSuite(): void {
    const suite: ClaudeProcessIOTDDSuite = {
...
`;
  ...
  private getCategoryToSuiteId(category: ClaudeProcessIOTDDTestCase['category']): string {
    const mapping = {
  ...
  generateCoverageReport(): {
    ...
    const testsByLevel: Record<string, number> = {};
    const coverageByCategory: Record<string, any> = {};
...
export const claudeProcessIOTDDPrevention = new ClaudeProcessIOTDDPreventionStrategies();