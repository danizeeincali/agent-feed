...
export class TDDPreventionStrategies {
  private strategies: Map<string, TDDStrategy> = new Map();
  ...
  generatePreventionPlan(detectedPatterns: string[]): any {
    const relevantStrategies = new Set<TDDStrategy>();
   ...
   */
  private getImplementationOrder(strategies: TDDStrategy[]): any {
    return {
   ...
   */
  private estimateEffort(strategies: TDDStrategy[]): any {
   ...
   */
  private calculatePreventionCoverage(strategies: TDDStrategy[], patterns: string[]): any {
    const allPreventedFailures = new Set<string>();
  ...
  private getStrategiesByCategory(): any {
  ...
  private getStrategiesByPriority(): any {
...
// Global instance
export const tddPreventionStrategies = new TDDPreventionStrategies();