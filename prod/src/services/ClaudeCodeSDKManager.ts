...
export class ClaudeCodeSDKManager {
   ...
   */
  async executeHeadlessTask(prompt: string, options?: Partial<QueryOptions>): Promise<QueryResult> {
...
let sdkManagerInstance: ClaudeCodeSDKManager | null = null;

export function getClaudeCodeSDKManager(): ClaudeCodeSDKManager {
