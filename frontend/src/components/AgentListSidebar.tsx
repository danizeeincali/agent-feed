  ...
  ({ agent, isSelected, onClick, renderBadges, renderIcon }) => {
    ...
    return (
      <button
        onClick={onClick}
        className={`
          w-full p-3 text-left transition-all hover:bg-gray-50 dark:hover:bg-gray-800
          ${isSelected ? 'bg-blue-50 dark:bg-blue-900/30 border-l-4 border-l-blue-600' : 'border-l-4 border-l-transparent'}
        `}
...
const LoadingState: React.FC = () => {
  return (
    <div className="divide-y divide-gray-100 dark:divide-gray-800" data-testid="loading-state">
      {[1, 2, 3, 4, 5].map((i) => (
