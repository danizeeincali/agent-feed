...
import { A as AlertTriangle, R as RefreshCw, H as Home, a as ArrowLeft, W as Wifi, b as WifiOff, c as AlertCircle, M as MoreHorizontal, T as TrendingUp, d as Heart, e as MessageCircle, S as Share2, P as Plus, f as Search, B as Bot, g as Play, h as Trash2, C as Clock, i as CheckCircle, U as User, j as Activity, D as Database, k as Users, l as BarChart3, m as PieChart, n as StopCircle, o as PlayCircle, p as Code, Z as Zap, q as Monitor, r as Terminal, s as Settings, K as Key, t as Download, u as Shield, v as Power, G as Globe, w as GitBranch, F as FileText, x as Grid3x3, L as List, y as Pause, z as Loader2, X, E as PenLine, I as Save, J as RotateCcw, N as Copy, O as MessageSquare, Q as Bell, V as FileJson, Y as FileCode, _ as Upload, $ as Send, a0 as ChevronRight, a1 as Server, a2 as Loader, a3 as Bug, a4 as LayoutDashboard, a5 as Workflow, a6 as Menu } from "./ui-D1Uz_4Sf.js";
(function polyfill() {
...
const RealSocialMediaFeed = ({ className = "" }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `max-w-2xl mx-auto ${className}`, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: (posts || []).map((post) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white text-sm font-medium mr-3", children: post.authorAgent.charAt(0).toUpperCase() }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-gray-900", children: post.authorAgent }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm", children: formatTimeAgo(post.publishedAt) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "text-gray-400 hover:text-gray-600", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MoreHorizontal, { className: "w-5 h-5" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold text-gray-900 mb-3", children: post.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "prose prose-sm max-w-none mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-700 whitespace-pre-wrap", children: post.content }) }),
      post.metadata && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
        post.metadata.businessImpact && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "w-4 h-4 mr-2 text-gray-500" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-600 mr-2", children: "Business Impact:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `text-sm font-medium ${getBusinessImpactColor(post.metadata.businessImpact)}`, children: [
            post.metadata.businessImpact,
            "%"
          ] })
        ] }),
        post.metadata.tags && post.metadata.tags.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1 mb-2", children: post.metadata.tags.map((tag, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "span",
          {
        ...
        post.metadata.isAgentResponse && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center px-2 py-1 bg-green-100 text-green-800 text-xs rounded-full", children: "🤖 Agent Response" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between pt-4 border-t border-gray-100", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex space-x-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "flex items-center space-x-1 text-gray-600 hover:text-blue-500 transition-colors", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "flex items-center space-x-1 text-gray-600 hover:text-green-500 transition-colors", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Share2, { className: "w-5 h-5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "Share" })
          ] })
        ] }),
...
//# sourceMappingURL=index-CbpE4f63.js.map
