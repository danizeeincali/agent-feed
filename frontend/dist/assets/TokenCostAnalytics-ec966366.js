import { u as useWebSocketSingleton, n as nldLogger, j as jsxRuntimeExports } from "./index-9c14506c.js";
import { r as reactExports } from "./vendor-77be6284.js";
import { A as AlertTriangle, a4 as DollarSign, R as RefreshCw, ab as Download, T as TrendingUp, au as TrendingDown, e as Activity, Z as Zap, c as BarChart3, a5 as Cpu } from "./ui-02a41228.js";
import "./router-07cff8bc.js";
import "./realtime-1f401a09.js";
import "./query-543ae44a.js";
...
const useTokenCostTracking = (config) => {
  ...
  const { socket, isConnected } = useWebSocketSingleton({
    url: {}.NEXT_PUBLIC_WEBSOCKET_URL || "http://localhost:3001",
    autoConnect: (config == null ? void 0 : config.enableRealTime) ?? true,
    reconnectAttempts: 3,
    reconnectDelay: 2e3
  });
  const calculateTokenCost = reactExports.useCallback((provider, model, inputTokens, outputTokens = 0) => {
    try {
      ...
      nldLogger.renderFailure("useTokenCostTracking", error2, { provider, model, inputTokens, outputTokens });
      return 0;
    }
  }, []);
  ...
  const calculateBudgetStatus = reactExports.useCallback(() => {
    try {
      if (!(config == null ? void 0 : config.budgetLimits) || !metrics) {
      ...
      nldLogger.renderFailure("useTokenCostTracking", error2, { budgetConfig: config == null ? void 0 : config.budgetLimits });
      setError(error2);
    }
  }, [config == null ? void 0 : config.budgetLimits, metrics, tokenUsages]);
    ...
    try {
      ...
      if (stored) {
        try {
          ...
          nldLogger.renderFailure("useTokenCostTracking", parseError, { action: "parse-storage" });
  ...
  reactExports.useEffect(() => {
    fetchHistoricalData();
    if ((config == null ? void 0 : config.enableRealTime) && socket) {
  ...
  }, [config == null ? void 0 : config.enableRealTime, socket, fetchHistoricalData, loading]);
  reactExports.useEffect(() => {
    if (metricsCalculationRef.current) {
      clearTimeout(metricsCalculationRef.current);
    }
...
const TokenCostAnalytics = ({
  ...
  const chartData = reactExports.useMemo(() => {
    if (filteredTokenUsages.length === 0)
      return [];
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-1", children: [
          ...
          !isConnected && tokenUsages.length > 0 && ((_b = (_a = tokenUsages[0]) == null ? void 0 : _a.metadata) == null ? void 0 : _b.demo) && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-amber-600 bg-amber-50 px-2 py-1 rounded-md", children: "Demo Mode" })
        ] })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-lg border border-gray-200 p-6 hover:shadow-lg transition-shadow", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
          ...
          (metrics == null ? void 0 : metrics.costTrend) === "increasing" ? /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "w-4 h-4 text-red-500" }) : (metrics == null ? void 0 : metrics.costTrend) === "decreasing" ? /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingDown, { className: "w-4 h-4 text-green-500" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: "w-4 h-4 text-gray-500" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${(metrics == null ? void 0 : metrics.costTrend) === "increasing" ? "bg-red-100 text-red-800" : (metrics == null ? void 0 : metrics.costTrend) === "decreasing" ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-800"}`, children: (metrics == null ? void 0 : metrics.costTrend) || "stable" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-lg border border-gray-200 p-6 hover:shadow-lg transition-shadow", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
...
//# sourceMappingURL=TokenCostAnalytics-ec966366.js.map
