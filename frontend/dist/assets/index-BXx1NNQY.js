...
import { A as AlertTriangle, R as RefreshCw, H as Home, a as ArrowLeft, W as Wifi, b as WifiOff, c as AlertCircle, X, C as ChevronDown, F as Filter, U as User, d as Hash, S as Settings, E as ExternalLink, I as Image, P as PlayCircle, e as ChevronUp, M as MessageCircle, f as Heart, B as Bookmark, T as Trash2, g as Plus, h as Search, i as Bot, j as Play, k as Clock, l as CheckCircle, m as Activity, D as Database, n as Users, o as TrendingUp, p as BarChart3, q as PieChart, r as StopCircle, s as Code, Z as Zap, t as Monitor, u as Terminal, K as Key, v as Download, w as Shield, x as Power, G as Globe, y as GitBranch, z as FileText, J as Grid3x3, L as List, N as Pause, O as Loader2, Q as PenLine, V as Save, Y as RotateCcw, _ as Copy, $ as MessageSquare, a0 as Bell, a1 as FileJson, a2 as FileCode, a3 as Upload, a4 as Send, a5 as ChevronRight, a6 as Server, a7 as Loader, a8 as Bug, a9 as LayoutDashboard, aa as Workflow, ab as Menu } from "./ui-Cy758l-A.js";
(function polyfill() {
...
const FilterPanel = ({
  ...
  const applyMultiSelectFilter = () => {
    if ((!tempFilter.agents || tempFilter.agents.length === 0) && (!tempFilter.hashtags || tempFilter.hashtags.length === 0)) {
      console.warn("No filters selected, not applying empty filter");
      return;
    }
    console.log("Applying multi-select filter:", tempFilter);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `relative ${className}`, children: [
    ...
    showMultiSelect && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-full left-0 mt-2 w-96 bg-white border border-gray-200 rounded-lg shadow-lg z-20 p-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-gray-100 py-4 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-6", children: [
            ...
            post.engagement?.saves && post.engagement.saves > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2 text-gray-600", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "w-4 h-4 text-red-500" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium", children: post.engagement.saves })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-gray-500", children: [
...
//# sourceMappingURL=index-BXx1NNQY.js.map
